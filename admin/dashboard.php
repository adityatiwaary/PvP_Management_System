    ...
    <div class="wrapper">
        <div class="sidebar col -l2 -s6">
            <ul>
                ...
                <li><a href="dashboard.php?page=manage_users_fst"><i class="fas fa-users"></i>PvP Courses</a></li>
                <li>
                    <div class="mdbtn">
                        <button class="dropdown-btn"><i class="fas fa-users"></i>
                            Student registered for PvP
                            <i class="fa fa-caret-down"></i>
                        </button>
                        <div class="dropdown-container">
                            <ul>
                                <li style="padding:5px;"><a href="dashboard.php?page=manage_users3">Semester 3</a></li>
                                <li style="padding:5px;"><a href="dashboard.php?page=manage_users4">Semester 4</a></li>
                                <li style="padding:5px;"><a href="dashboard.php?page=manage_users5">Semester 5</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
                ...
                <li><a href="dashboard.php?page=timetable"><i class="fas fa-plus"></i>Schedule and Results</a></li>
            </ul>
        </div>
        <div class="col-sm-12 col-sm-offset-12 col-md-10 col-md-offset-2 main">
            ...
            @$page =  $_GET['page'];
            if ($page != "") {
                if ($page == "manage_users3") {
                    include('manage_users3.php');
                }

                if ($page == "manage_users4") {
                    include('manage_users4.php');
                }

                if ($page == "manage_users5") {
                    include('manage_users5.php');
                }
