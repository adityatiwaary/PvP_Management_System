<?php
    ...
    $query1 = "SELECT * FROM registration WHERE sem=3";
...
<body>
    ...
    <br /><br /><br /><br /><br /><br />
    <h2 style="color:#ff0000;font-family:'Acme';" class = "page-header"><u>Number of Registered Students in Semester 3:</u></h2>
