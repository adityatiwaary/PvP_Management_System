<?php
    ...
    $query1 = "SELECT * FROM registration WHERE sem=4";
    $result = mysqli_query($con,$query1);
    $rr=mysqli_num_rows($result);
    if(!$rr)
    {
    echo "<h2 style='color:red;color:#ff0000;font-family:Acme;position:relative;top:35px;left:30%;''>No Students Have Registered For PvP Yet.</h2>";
    }
    else
    {
?>
...
<body>
    <img id="head" width="380px" style = "font-family:'PT Serif';" left:10 align='left' src = "../css/images/rvceheader.png">
    <br /><br /><br /><br /><br /><br />
    <h2 style="color:#ff0000;font-family:'Acme';" class = "page-header"><u>Number of Registered Students in Semester 4:</u></h2>
