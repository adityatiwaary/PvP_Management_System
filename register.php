        ...
        <form name="register" method="post" class="myform" action="" enctype="multipart/form-data">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td class="td1">
                        <input type="email" name="mail" autocomplete="off" placeholder="student.xx21@rvce.edu.in" required />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="td1">
                        <select name="dept" class="select1" autocomplete="off" placeholder="Information Science" required>
                ...
                <tr>
                    ...
                    <td class="td1">
                        <input type="phone" autocomplete="off" name="phone" id="phone" placeholder="XXXXXXXXXX" />
                    </td>
                </tr>
